...
Original file is located at
    https://colab.research.google.com/drive/1KYTcm-G4BbcGb-D0dXKs_Aaxr9JhjLTW
"""
...
data = pd.read_csv('/content/drive/MyDrive/Farzi/data_banknote_authentication.xls', header=None)
